...
const { calculatePayroll, getPayrollHistory, downloadPayslip, markPayrollPaid, deletePayrollHistory, updateManualAdvanceDeduction } = require('../controllers/payroll.controller');
