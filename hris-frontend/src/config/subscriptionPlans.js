...
export const MENU_SECTIONS = [
  ...
  },
  {
    ...
    type: 'group',
    items: [
      { feature: 'staff_directory', requiredPlan: 'BUSINESS_PRO', label: 'Staff Directory', route: '/admin/employees' },
      { feature: 'attendance',      requiredPlan: 'BUSINESS_PRO', label: 'Attendance',      route: '/admin/calendar' },
      { feature: 'leaves',          requiredPlan: 'BUSINESS_PRO', label: 'Leaves',           route: '/admin/leaves' },
      { feature: 'payroll',         requiredPlan: 'BUSINESS_PRO', label: 'Payroll',          route: '/admin/payroll' },
      { feature: 'advances',        requiredPlan: 'BUSINESS_PRO', label: 'Advances',         route: '/admin/advances' },
      { feature: 'replacements',    requiredPlan: 'BUSINESS_PRO', label: 'Replacements',     route: '/admin/replacements' },
    ],
  },
  {
    feature: 'invoices',
